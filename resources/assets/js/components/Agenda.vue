	...
	<div class="drag">
		<div class="columns is-desktop">
			...
			<div class="column">
		      ...
		      <draggable v-model="reservationsData.pagination.data" class="dragArea" :options="{group:'reservations'}"  >
		     
			   		<reservation :element="element" v-for="element in reservationsData.pagination.data"></reservation>
				
		      </draggable>
			  <nav class="pagination-bulma">
					<laravel-pagination :data="reservationsData.pagination" v-on:pagination-change-page="getReservations"></laravel-pagination >
				</nav>
			</div>
		</div>
